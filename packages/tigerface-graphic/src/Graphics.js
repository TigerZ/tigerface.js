...
class Graphics extends Context {
    ...
    _drawLine(line, style) {
        ...
        if (style === Graphics.LineStyle.SOLID) {
            ...
            this._drawSimpleDotLine(
                line.p0.x, line.p0.y, line.p1.x, line.p1.y, this.lineStyle.dotLength,
                this.lineStyle.blankLength,
            );
        } else if (style === Graphics.LineStyle.DASH) {
            this._drawSimpleDotLine(
                line.p0.x, line.p0.y, line.p1.x, line.p1.y, this.lineStyle.dashLength,
                this.lineStyle.blankLength,
            );
            ...
            const xLen = Math.cos(line.getSlope()) * (this.lineStyle.dashLength + this.lineStyle.blankLength);
            const yLen = Math.sin(line.getSlope()) * (this.lineStyle.dashLength + this.lineStyle.blankLength);
            this._drawSimpleDotLine(
                line.p0.x + xLen, line.p0.y + yLen, line.p1.x, line.p1.y, this.lineStyle.dotLength,
    ...
    _drawSimpleDotLine(x0, y0, x1, y1, dotLength, blankLength) {
        ...
        const length = this._distance(x0, y0, x1, y1);
