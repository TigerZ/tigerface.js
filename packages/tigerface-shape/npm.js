module.exports = {
    'Circle': require('./lib/Circle').default,
    ...
    'Point': require('./lib/Point').default,

    'Polygon': require('./lib/Polygon').default,
    'QuadraticBezier': require('./lib/QuadraticBezier').default,
    'Rectangle': require('./lib/Rectangle').default,
    'RightTriangle': require('./lib/RightTriangle').default,
